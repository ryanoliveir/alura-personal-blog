...
// import aboutMeConverImage from "../../../public/assets/aboutme_cover.png";
const AboutMe = () => {
    return (
        <div>
            <PostModel
                coverImage={'aboutme_cover.png'}
                postTitle={"About Me"}
            >
                ...
                <img
                  ...
                  src={process.env.PUBLIC_URL + 'assets/aboutme_picture.png'} alt="Personal" 
                />
